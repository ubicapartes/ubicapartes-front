...
public class ListaCuentasUbicapartesViewModel extends AbstractRequerimientoViewModel implements
	...
	private String fromList = "Ubicapartes";
	...
	public void cambiarCuentasUbicapartes(@Default("0") @BindingParam("page") int page, @BindingParam("fieldSort") String fieldSort, @BindingParam("sortDirection") Boolean sortDirection) {
		...
		if(usuario.getPersona().getTipoMenu()!=null && !usuario.getPersona().getTipoMenu().toString().isEmpty() && !isAdminOrAnalista()){
				cuentaFiltro.getProveedor().setId(null);
		}
		
		Map<String, Object> parametros = sMaestros.consultarCuentasUbicapartes(cuentaFiltro,  fieldSort, sortDirection, page, pageSize);
	...
	public void paginarLista() {
		...
		cambiarCuentasUbicapartes(page, null, null);
	}
